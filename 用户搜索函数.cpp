...
void Commodity_p::user_search()
{
	...
	while (1)
	{
		cout << "\t\t\t\t\t\t\t         =====================" << endl;
		cout << "\t\t\t\t\t\t\t          1.根据商品名称搜索：\n" << endl;
		cout << "\t\t\t\t\t\t\t          2.根据商品类型搜索：" << endl;
		cout << "\t\t\t\t\t\t\t         =====================" << endl;
		cout << "\t\t\t\t\t\t\t           请选择搜索类型："; cin >> h;
		if (h == 1 || h == 2) break;
		else cout << "\t\t\t\t\t\t\t       操作错误，请重新操作："  << endl;
	}
	int w = 0;
	Commodity* t = first;
	if (h == 1)
		...
		while (t)
		{
			...
			if ((i % 5 == 0 && t->next != NULL) || t->next == NULL)
			{
				while (1)
				{
					...
					cout << "\t\t\t\t\t\t\t   ****************************************" << endl;
					cout << " \t\t\t\t\t\t\t          ";
					if (ch == "0") { cout << "                                                              "; getchar(); getline(cin, ch); }
					else if (y == 1 || y == 2)
					{
						cout << "                                                              "; getchar(); getline(cin, ch);
					...
					else { ch = "129"; cout << "操作错误，重新操作！" << endl; }
